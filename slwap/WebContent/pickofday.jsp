...
//                var date1 = document.getElementById("date-pick").value;
        ...
        <script>
         function func1(parameter1){
                  window.location = "http://122.160.233.120/slwap/DownloadAnimation?content_name="+parameter1;
                   }
        </script>
...
<%
 ...
 <body onload="javascript:showonlyone('newboxes1');">
 <%} else {
 System.out.println("session value in sriwap.jsp "+session.getAttribute("divVal"));
 %>
...
<!--                                <section class="head-cat">
                            ...
                            <div class="newboxes" id="newboxes2"><h2 style="text-align:right;">à®ªà®à®à¯à®à®³à¯</h2></div>     
                            <div class="newboxes" id="newboxes3"><h2 style="text-align:right;">à¶»à·à¶´</h2></div>     
...
//                                    String root_path = "http://wap.tesync.net/m4u/CMS/Preview/";
                                    ...
                                    ResultSet rs = gc.getContentCatWise("animation", "Ultra Hot Babes", "9");
