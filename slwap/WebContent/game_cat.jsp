...
//                var date1 = document.getElementById("date-pick").value;
                ...
                xmlhttp.open("GET", "gameallCat.jsp?cat_type=" + cat_type, true);
                xmlhttp.send();
            }
        </script>
       ...
       <script>
         function func1(parameter1){
                  window.location = "http://122.160.233.120//slwap/DownloadGame?content_name="+parameter1;
                   }
        </script>
...
//                        db.close();
       ...
       <section class="container">
            <section class="sri-area">
                ...
                <section class="container">
                <section class="sri-area">
                    <%@include file="headers/gameCat.jsp" %>
                    <div id="wait">
                            <section class="row">
...
//                                    String root_path = "http://wap.tesync.net/m4u/CMS/Preview/";
                                    ...
                                    ResultSet rs = gc.getContentCatWise("game", cat_type, "9");
