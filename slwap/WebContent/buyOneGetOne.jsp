<%-- 
    Document   : freeZone
    Created on : Feb 8, 2016, 6:01:46 PM
...
<!--                                    <h3>Images</h3>     -->
                                       <div class="newboxes" id="newboxes1">    <h3>Images</h3></div>
                                            <div class="newboxes" id="newboxes2">   <p class="cata">வால்பேப்பர்</p></div>
                                            <div class="newboxes" id="newboxes3">   <p class="cata">ෙවෝල් ෙප්පර්<</p> </div>
                                ...
                                <%                              String path = "../m4u/CMS/Preview/";
                                    ...
                                    ResultSet rs = gc.getRandomContent("wallpaper", "3");
                                ...
                                <section class="head-cat">
<!--                                    <h3>Animations</h3>    -->
                                      <div class="newboxes" id="newboxes1">    <h3>Animations</h3></div>
                                            <div class="newboxes" id="newboxes2">   <p class="cata">வால்பேப்பர்</p></div>
                                            <div class="newboxes" id="newboxes3">   <p class="cata">ෙවෝල් ෙප්පර්<</p> </div>

                                </section>
                                <%          rs = gc.getRandomContent("animation", "3");
                                ...
                                <section class="col-md-4 col-xs-4">
                                    <section class="wall-pic">
                                        <input type="image" src="<%= path + rs.getString(2)%>" onclick="func1('<%=rs.getString(2)%>');"/>
                                ...
                                <section class="head-cat">
<!--                                    <h3>Videos</h3>   -->
                                    <div class="newboxes" id="newboxes1">    <h3>Videos</h3></div>
                                            <div class="newboxes" id="newboxes2">   <p class="cata">வால்பேப்பர்</p></div>
                                            <div class="newboxes" id="newboxes3">   <p class="cata">ෙවෝල් ෙප්පර්<</p> </div>

                                </section>
                                <%          rs = gc.getRandomContent("video", "3");
                                             while (rs.next()) {
                                        System.out.println(" in resultset ********srlanka " + rs.getString(2));
                                %>
                                ...
                                <section class="head-cat">
<!--                                    <h3>Games</h3>       -->
<div class="newboxes" id="newboxes1">    <h3>Games</h3></div>
                                            <div class="newboxes" id="newboxes2">   <p class="cata">வால்பேப்பர்</p></div>
                                            <div class="newboxes" id="newboxes3">   <p class="cata">ෙවෝල් ෙප්පර්<</p> </div>

                                </section>
                                <%          rs = gc.getRandomContent("game", "3");
