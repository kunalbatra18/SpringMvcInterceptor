...
ServletOutputStream out;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("game/jar");
...
//                "attachment;filename=" + video_name+".3gp");
        ...
        response.setHeader("Content-Disposition",
                "attachment;filename=" + name_without_format+".apk");
        System.out.println(" caing downloading content ");
       
        out = response.getOutputStream();

        String path = "/usr/local/apache-tomcat-8.0.27/webapps/m4u/m4u/CMS/Content/" +name_without_format + ".apk";
        ...
        if (!file.exists()) {
            ...
            path = "/usr/local/apache-tomcat-8.0.27/webapps/m4u/CMS/Content/" +name_without_format + ".apk";
        }
        ...
        try {
            ...
            System.out.println(" exception in DownloadGame in doget method " + ex);
        }
}
