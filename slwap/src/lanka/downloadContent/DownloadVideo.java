...
//                "attachment;filename=" + video_name+".3gp");
        ...
        response.setHeader("Content-Disposition",
                "attachment;filename=" + name_without_format+".3gp");
        System.out.println(" caing downloading content ");
       
        out = response.getOutputStream();

        String path = "/usr/local/apache-tomcat-8.0.27/webapps/m4u/CMS/Content/Video/" +name_without_format + ".3gp";
        ...
        if (!file.exists()) {
            ...
            path = "/usr/local/apache-tomcat-8.0.27/webapps/m4u/CMS/Content/Video/" +name_without_format + ".3gp";
        }
