 ...
 * @author sushil
 */
public class DownloadAnimation extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String ani_name = request.getParameter("content_name");

        //response.setContentType("image/gif");
        response.setContentType("application/octet-stream");
        response.setHeader("Content-Disposition", "attachment;filename=" + ani_name);
        ...
        format = ".gif";
        String path = "";
        String name_without_format = nameWithoutFormat(ani_name);
        name_without_format = name_without_format.replaceAll("Animation", "");
        path = "/usr/local/apache-tomcat-8.0.27/webapps/m4u/CMS/Content/Animation/" + size + name_without_format + ".gif";
